...
if(getCookie("id") !== "" && getCookie("id") !== "0") {
    ...
    function login() {
        if (loginFree) {
            ...
            apiPost("login", {email: $("#emaillog").val(), password: $("#passlog").val()}).then(g => {
                loginFree = !0;
    ...
    function saibamais() {
        $("#parent").animate({scrollTop: $("#saibamais-content").offset().top}, 700)
    }

    function goToLogin() {
        $("#parent").animate({scrollTop: $("#background-login").offset().top}, 1100);
    ...
    $(function () {
        ...
        $("#parent").scroll(function () {
            ...
            let animationCount = {first: !1, second: !1, third: !1, forth: !1, fifth: !1,};
